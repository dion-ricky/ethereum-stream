...
COPY ./flink-consumer /opt/flink-consumer
RUN cd /opt/flink-consumer; mvn clean verify
...
COPY --from=builder /opt/flink-consumer/target/flink-consumer-*.jar /opt/flink/usrlib/flink-consumer.jar
